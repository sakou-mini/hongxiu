...
public class TimeUtil {
    ...
    public static long timeStrToTimestamp(String strTime){
        if(StringUtils.isNullOrBlank(strTime)) return 0;
        try {
          return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(strTime).getTime();
