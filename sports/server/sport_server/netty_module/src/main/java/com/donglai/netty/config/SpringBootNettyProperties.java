/*
package com.donglai.netty.config;
...
public class SpringBootNettyProperties {
    ...
    private int port;
    private final Integer readerIdleTimeSeconds = 60;
    private final Integer writerIdleTimeSeconds = 30;
    private final Integer allIdleTimeSeconds = 30;
    private final Integer bossGroupThreadSize = 1;
    private final Integer workGroupThreadSize = 4;
