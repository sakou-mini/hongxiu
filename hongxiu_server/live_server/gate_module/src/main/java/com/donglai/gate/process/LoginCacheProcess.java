...
import static com.donglai.protocol.Constant.ResultCode.REPEATED_LOGIN;
...
public class LoginCacheProcess {
    public static void loginSuccess(String userid, Map<KafkaMessage.ExtraParam, String> extraParams, Constant.PlatformType platform) {
        ...
        String lastUserId = extraParams.getOrDefault(KafkaMessage.ExtraParam.USER_ID, "");
    ...
    private static void repeatedLogin(ChannelHandlerContext ctx) {
        ...
        GateUtil.sendMessageToChannel(ctx, buildReply(replyBuilder.build(), REPEATED_LOGIN));
    }
