...
import static com.donglai.web.constant.WebPathConstant.DEFAULT_AVATAR;
...
public class PlatformApiProcess {
    ...
    public PlatformRoomListReply getPlatformRoomListReply(PlatformToken tokenResult) {
        ...
        ArrayList<String> domains = Lists.newArrayList(domainUrl);
    ...
    public User initDuoCaiUserAndBecomeLiveUser(String account) {
        ...
        if (user == null) {
            ...
            user = userBuilder.createUser(account, PasswordUtil.encodePassword(password), DEFAULT_AVATAR, platform);
        }
