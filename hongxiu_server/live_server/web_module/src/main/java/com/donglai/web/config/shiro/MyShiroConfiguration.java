...
public class MyShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        //3.动态权限认证
        List<Menu> allMenu = menuService.findAllByMenuType(MenuType.MENU_API);
        allMenu.forEach(menu -> filterChainDefinitionMap.put(menu.getPath(), menu.getPermissionStr()));
    ...
    public RedisManager redisManager() {
        ...
        redisManager.setTimeout(1800);// 连接超时时间
    ...
    public RedisSessionDAO redisSessionDAO() {
        ...
        //redisSessionDAO.setExpire(5000); //shiro session 过期时间（s）
