...
public class HttpClientNetty {
    ...
    public static void login(Channel channel) {
        Live.LiveOfLoginRequest.Builder loginRequest = Live.LiveOfLoginRequest.newBuilder().setAccountId("asdas").setPassword("213213");
        HongXiu.HongXiuMessageRequest message = HongXiu.HongXiuMessageRequest.newBuilder().setLiveOfLoginRequest(loginRequest).build();
