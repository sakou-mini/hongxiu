    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'total', title: '参与人数',align:"center"},
                {field: 'totalCoin', title: '竞猜总金额',align:"center"},
                {field: 'wagerStartTime', title: '开始下注时间',align:"center"},
                {field: 'wagerEndTime', title: '结束下注时间',align:"center"},
        ...
        table.on('tool(demo)', function(obj){
            var data = obj.data;
            if(obj.event === 'detail'){
                jumpDetailsUrl("guessStatisticsDetails","id",data.id)
            }
        });
    })
}
    ...
    layui.use('laypage', function() {
        ...
        laypage.render({
            ...
            jump: function (obj, first) {
                ...
                if(!first){
                    $.get({
                        url: window.ioApi.guess.getGuessStatisticsList,
                        data: {
                            page:page,
                            size:size
                        },
