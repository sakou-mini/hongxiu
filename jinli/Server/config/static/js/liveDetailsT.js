...
displayRoleElement(["CLOSTLIVET"],"closeRoom")
displayRoleElement(["SEARCHUSERIDLIVEROOMLISTT"],"userIdSearch")
...
function messageInfo(res) {
    var init = function () {
        $("#"+res.initBox).html(res.msg)
    }
    var fuilter = function (data) {
