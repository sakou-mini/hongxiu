...
function tableDataList(list) {
    layui.use('table', function () {
        ...
        table.render({
            ...
            cols: [[
                {field: 'id', title: '竞猜ID'},
                {field: 'title', title: '竞猜标题'},
                {field: 'guessType', title: '竞猜类型'},
                {field: 'showStartTime', title: '展示开始时间'},
                {field: 'showEndTime', title: '展示结束时间'},
                {field: 'wagerStartTime', title: '下注开始时间'},
                {field: 'wagerEndTime', title: '下注结束时间'},
                {field: 'sort', title: '排序'},
    ...
    layui.use('laypage', function() {
        ...
        laypage.render({
            ...
            jump: function (obj, first) {
                ...
                if(!first){
                    $.get({
                        url: window.ioApi.guess.getWagerOverGuess,
                        data: sendObj,
