...
displayRoleElement(["LIVEUSERRECORDSEARCHLIVEUSERID"], "searchLiveUserId")
displayRoleElement(["LIVEUSERRECORDEXCEL"], "excel")
...
function tableData (list) {
  layui.use('table', function () {
    ...
    roleTableBtn(["LIVEUSERRECORDLIVEUSERDETAILINFO"], "detail")
  });
}
