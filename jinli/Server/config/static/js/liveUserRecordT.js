...
displayRoleElement(["LIVEUSERRECORDTSEARCHLIVEUSERID"],"idSearch")
displayRoleElement(["LIVEUSERRECORDTEXCEL"],"excel")
...
function tableData(list) {
    layui.use('table', function(){
        ...
        roleTableBtn(["LIVEUSERRECORDTDETAILINFOT"],"detail")
    });
}
