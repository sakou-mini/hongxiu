        ...
        laypage.render({
            ...
            jump: function(obj, first){
                ...
                if(!first){
                    ...
                    data.size = obj.limit;
                    $.get({
                        url:window.ioApi.revenueAnalysis.getGiftIncomeRecords,
                        data:data,
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            , cols: [[
                ...
                {field: 'userName', title: '赠礼用户昵称（用户ID）',width:250,align:"center"},
                ...
                {field: 'sendTime', title: '收礼时间',align:"center"},
...
function analogData() {
    var liveUserId = $("#element").val().trim();
    var liveUserName = $("#class").val().trim();
...
function getFormData() {
    ...
    var liveUserId = $("#class").val().trim();
    var liveUserName = $("#element").val().trim();
    var roomId = $("#roomId").val().trim();
    var startTime = time1;
    var endTime = time2;
    return {
