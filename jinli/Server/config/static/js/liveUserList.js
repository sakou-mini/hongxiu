...
//     $('#violationType').siblings("div.layui-form-select").find('dl').find(select).click();
// }
// var nowPage = 1 ;
...
//                     var roomId = $("#room").val();
//                     $.get({
//                         url:window.ioApi.liveUser.getLiveUserList,
//                         data:{
//                             page:obj.curr,
//                             size:obj.limit,
//                             liveUserId:liveUserId.trim(),
//                             userId:userId.trim(),
//                             roomId:roomId.trim(),
//                         },
...
//             , cols: [[
//                 // {field: 'id', title: '主播ID'},
//                 // {field: 'displayName', title: '昵称',minWidth: 110},
//                 {field: 'avatarUrl', title: '主播昵称',templet:'#imgTemplet'},
//                 {field: 'realName', title: '等级'},
//                 {field: 'realName', title: '总收入'},
//                 {field: 'realName', title: '月在线时长'},
//                 {field: 'realName', title: '签约时间'},
//                 // {field: 'phoneNumber', title: '手机号',minWidth: 110},
//                 {field: 'getGameCoin', title: '持有金币', sort: true},
...
//             var data = obj.data;
//             if(obj.event === 'detail'){
//                 jumpDetailsUrl("liveUserDetailInfo","liveUserId",data.id)
//             }
//         });
//     });
// }
...
displayRoleElement(["SEARCHLIVEUSERID"],"liveUserIdSearch")
//eChart
...
function getChartData() {
    $.get({
        ...
        data:{platform:parseInt($("#platform").val())},
        success:function (res) {
            console.log(res);
...
function tableData(list) {
    ...
    layui.use('table', function(){
        ...
        roleTableBtn(["LIVEUSERDETAILINFO"],"detail")
