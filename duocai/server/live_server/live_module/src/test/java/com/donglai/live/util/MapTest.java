...
public class MapTest extends BaseTest {
    ...
    public void test(){
        ...
        platformUserMap.computeIfAbsent(Constant.PlatformType.DUOCAI, k -> new HashMap<>()).put("1", "1");
        platformUserMap.computeIfAbsent(Constant.PlatformType.DUOCAI, k -> new HashMap<>()).put("2", "2");
