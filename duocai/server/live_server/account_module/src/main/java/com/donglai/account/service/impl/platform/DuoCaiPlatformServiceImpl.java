...
import static com.donglai.protocol.Constant.ResultCode.ACCOUNT_BANNED;
...
public class DuoCaiPlatformServiceImpl implements PlatformService {
    ...
    public User register(Account.AccountOfRegisterRequest request, Constant.PlatformType platform) {
        ...
        User user = userBuilder.createUser(password, request.getMobileCode(), 0, DEFAULT_AVATAR_PATH, Constant.PlatformType.DUOCAI);
        liveUserProcess.becomeSimpleLiveUser(user,Constant.PlatformType.DUOCAI);
        return user;
    }
